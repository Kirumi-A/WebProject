...
myWindow.style.position = 'absolute';  // Necesario para que top/left funcionen
myWindow.style.top = '400px';  // Cambia este valor para la posición vertical inicial
myWindow.style.left = '60px';  // Cambia este valor para la posición horizontal inicial
...
document.addEventListener('click', e => {
    if (e.target.closest('.round.three')) {
        e.target.closest('.window').remove();
    }
});

//This example uses vanilla JavaScript to accomplish draggable elements!
